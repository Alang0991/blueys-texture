...
public class BlueysTextureGUI : ShaderGUI
{
    ...
    void DrawValidation(MaterialEditor editor, Material mat)
    {
        ...
        if (valOpen)
        {
            ...
            if (normal != null && normal.dimension != TextureDimension.Tex2D)
            {
    ...
    void ApplyFix(Material mat, int index, Texture main, Texture normal)
    {
        switch (index)
        {
            case 0:
